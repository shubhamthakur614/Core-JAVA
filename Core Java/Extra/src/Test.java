...
//		Map<String, Long> collect = employeeList.stream().collect(Collectors.groupingBy(Emp::getGender,Collectors.counting()));
//
//		System.out.println(collect);
//		
//		employeeList.stream().map(Emp::getDepartment).distinct().forEach(System.out::println);
//		
//		Map<String, Double> collect2 = employeeList.stream().collect(Collectors.groupingBy(Emp::getGender,Collectors.averagingDouble(Emp::getAge)));
